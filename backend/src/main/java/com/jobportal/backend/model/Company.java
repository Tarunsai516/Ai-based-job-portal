...
public class Company {
    ...
    public Company(Long id, String name, String industry, String location, String employees,
    ...
    public static class Builder {
        ...
        public Company build() {
            return new Company(id, name, industry, location, employees, website, description, recruiterId);
        }
    }
}
