...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedUsersAndJobs() {
        ...
        Candidate c1 = Candidate.builder()
                ...
                .avatar("👨‍💻")
                .skills(List.of("React", "JavaScript", "TypeScript", "Tailwind CSS", "Java", "Spring Boot", "PostgreSQL"))
        ...
        Job j1 = Job.builder()
                ...
                .benefits(List.of("Health & Dental insurance", "401(k) matching", "Flexible remote work", "$2,000 learning budget"))
        ...
        Job j2 = Job.builder()
                ...
                .benefits(List.of("Comprehensive health coverage", "Equity grants", "Annual company retreats"))
                .recruiterId(recruiterIdStr)
                .recruiterName("Jane Recruiter")
                .recruiterEmail(recruiterEmail)
