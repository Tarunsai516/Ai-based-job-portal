...
public class ApplicationResponse {
    ...
    public static class Builder {
        ...
        public Builder appliedDate(String appliedDate) { this.appliedDate = appliedDate; return this; }
        ...
        public ApplicationResponse build() {
            return new ApplicationResponse(id, jobId, jobTitle, companyName, status,
