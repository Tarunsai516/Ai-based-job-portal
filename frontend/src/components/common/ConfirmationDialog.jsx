    ...
    <Modal isOpen={isOpen} onClose={onClose} title={title}>
      <div className="space-y-4">
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-gray-100 dark:border-gray-700">
          <button
            onClick={onClose}
            className="px-4 py-2 border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs font-semibold rounded-lg transition-colors focus:outline-none"
          >
            {cancelText}
          </button>
          <button
