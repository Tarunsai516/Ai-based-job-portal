...
import { HiOutlineBell, HiOutlineCheckCircle, HiOutlineClock } from 'react-icons/hi';

export default function CandidateNotifications() {
  const [notifications, setNotifications] = useState(
    initialNotifications.filter((n) => n.role === 'seeker')
  );
    ...
    <DashboardLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-xl font-bold text-gray-905">Notifications</h1>
            <p className="text-xs text-gray-500 mt-0.5">Observe developer triggers and status alerts.</p>
          </div>
        ...
        {notifications.length === 0 ? (
          <div className="bg-white border border-gray-200 rounded-xl p-8 text-center space-y-2 shadow-sm">
            ...
            <h3 className="text-sm font-bold text-gray-800">You are all caught up!</h3>
            <p className="text-xs text-gray-500">We'll alert you as soon as new matching vacancies are posted.</p>
          </div>
        ) : (
            ...
            {notifications.map((n) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-650 mt-0.5 leading-relaxed">{n.message}</p>
